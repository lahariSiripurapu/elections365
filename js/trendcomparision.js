var myObj = "";
		...
		$(document).ready(function() {
    		...
    		$.ajax({
        		type: "GET",
        		url: "data/trendwise_chhattisgarh.csv",
        		dataType: "text",
	...
	function stateChange(selectS){
		...
		if (selectS.value=='MadhyaPradesh'){
			$.ajax({
        	type: "GET",
        	url: "data/trendwise_madhyapradesh.csv",
        	dataType: "text",
        	success: function(data) {processData(data);}
     		});
		}
		if (selectS.value=='Mizoram'){
			$.ajax({
        	type: "GET",
        	url: "data/trendwise_mizoram.csv",
        	dataType: "text",
        	success: function(data) {processData(data);}
     		});
		}
		if (selectS.value=='Rajasthan'){
			$.ajax({
        	type: "GET",
        	url: "data/trendwise_rajasthan.csv",
        	dataType: "text",
        	success: function(data) {processData(data);}
     		});
		}
		if (selectS.value=='Telangana'){
			$.ajax({
        	type: "GET",
        	url: "data/trendwise_telangana.csv",
        	dataType: "text",
        	success: function(data) {processData(data);}
     		});
		}
